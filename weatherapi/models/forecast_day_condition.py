...
class ForecastDayCondition(object):
    ...
    def __init__(self, text=None, icon=None, code=None, _configuration=None):  # noqa: E501
        """ForecastDayCondition - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def text(self):
        """Gets the text of this ForecastDayCondition.  # noqa: E501


        :return: The text of this ForecastDayCondition.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this ForecastDayCondition.


        :param text: The text of this ForecastDayCondition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def icon(self):
        """Gets the icon of this ForecastDayCondition.  # noqa: E501


        :return: The icon of this ForecastDayCondition.  # noqa: E501
        :rtype: str
        """
        return self._icon
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this ForecastDayCondition.


        :param icon: The icon of this ForecastDayCondition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def code(self):
        """Gets the code of this ForecastDayCondition.  # noqa: E501


        :return: The code of this ForecastDayCondition.  # noqa: E501
        :rtype: int
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this ForecastDayCondition.


        :param code: The code of this ForecastDayCondition.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ForecastDayCondition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForecastDayCondition):
            return False
