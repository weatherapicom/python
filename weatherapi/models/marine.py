...
class Marine(object):
    ...
    """
    swagger_types = {
        'forecastday': 'list[MarineForecastday]'
    }
    ...
    def __init__(self, forecastday=None, _configuration=None):  # noqa: E501
        """Marine - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._forecastday = None
        self.discriminator = None

        if forecastday is not None:
            self.forecastday = forecastday

    @property
    def forecastday(self):
        """Gets the forecastday of this Marine.  # noqa: E501


        :return: The forecastday of this Marine.  # noqa: E501
        :rtype: list[MarineForecastday]
        """
        return self._forecastday

    @forecastday.setter
    def forecastday(self, forecastday):
        """Sets the forecastday of this Marine.


        :param forecastday: The forecastday of this Marine.  # noqa: E501
        :type: list[MarineForecastday]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Marine):
            return False
