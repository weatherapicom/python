...
class CurrentCondition(object):
    ...
    def __init__(self, text=None, icon=None, code=None, _configuration=None):  # noqa: E501
        """CurrentCondition - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def text(self):
        """Gets the text of this CurrentCondition.  # noqa: E501


        :return: The text of this CurrentCondition.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this CurrentCondition.


        :param text: The text of this CurrentCondition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def icon(self):
        """Gets the icon of this CurrentCondition.  # noqa: E501


        :return: The icon of this CurrentCondition.  # noqa: E501
        :rtype: str
        """
        return self._icon
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this CurrentCondition.


        :param icon: The icon of this CurrentCondition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def code(self):
        """Gets the code of this CurrentCondition.  # noqa: E501


        :return: The code of this CurrentCondition.  # noqa: E501
        :rtype: int
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this CurrentCondition.


        :param code: The code of this CurrentCondition.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CurrentCondition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CurrentCondition):
            return False
