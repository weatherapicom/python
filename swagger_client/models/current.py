...
class Current(object):
    ...
    def __init__(self, last_updated_epoch=None, last_updated=None, temp_c=None, temp_f=None, is_day=None, condition=None, wind_mph=None, wind_kph=None, wind_degree=None, wind_dir=None, pressure_mb=None, pressure_in=None, precip_mm=None, precip_in=None, humidity=None, cloud=None, feelslike_c=None, feelslike_f=None, vis_km=None, vis_miles=None, uv=None, gust_mph=None, gust_kph=None, air_quality=None):  # noqa: E501
