...
class AlertsAlert(object):
    ...
    def __init__(self, headline=None, msgtype=None, severity=None, urgency=None, areas=None, category=None, certainty=None, event=None, note=None, effective=None, expires=None, desc=None, instruction=None):  # noqa: E501
